	...
	cases := []multipartestutils.TestCase{
		{
			...
			ReqFunc: func() *http.Request {
				...
				req := multipartestutils.NewMultipartBuilder().
					...
					AddField("HeroImage.Values", "{\"ID\":1,\"Url\":\"//r0vx-test.s3.ap-northeast-1.amazonaws.com/system/media_libraries/1/file.jpeg\",\"VideoLink\":\"\",\"FileName\":\"demo image.jpeg\",\"Description\":\"\",\"FileSizes\":{\"@r0vx_preview\":8917,\"default\":326350,\"main\":94913,\"og\":123973,\"original\":326350,\"thumb\":21199,\"twitter-large\":117784,\"twitter-small\":77615},\"Width\":750,\"Height\":1000}").
